...
class PlanningTool(BaseTool):
    ...
    def create_execution_plan(self, session_id: str, scenario: str, time_description: Optional[str] = None, planned_order_id_filter: Optional[List[str]] = None, limit: Optional[int] = None, item_type_filter: Optional[str] = None, reschedule_duration: Optional[str] = None, use_last_query: bool = False) -> str:
